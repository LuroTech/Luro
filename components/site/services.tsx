                        ...
                        <FadeIn key={service.number} custom={i + 1} className="h-full">
                            <TiltCard>
                                ...
                                >
                                    <div
                                        className={cn(
                                            "mb-6 h-1.5 w-12 rounded-full bg-gradient-to-r to-transparent transition-all duration-500 group-hover:w-20",
                                            service.accent
                                        )}
                                    />
                                    <span className="font-mono text-sm tracking-widest text-white/30 transition-colors duration-500 group-hover:text-white/60">
                                        {service.number}
                                    </span>
