            ...
            <div className="container mx-auto px-4 md:px-6">
                <dl className="grid grid-cols-2 divide-white/[0.08] md:grid-cols-4 md:divide-x">
                    {stats.map((stat, i) => (
                        ...
                        >
                            <dd className="order-first font-mono text-3xl font-bold tracking-tight transition-transform duration-500 group-hover:scale-110 group-active:scale-110 md:text-4xl">
                                <CountUp
                                    target={stat.target}
                                    suffix={stat.suffix}
